 ...
 * @author T-REX
 */
public class FaceBeansFrame extends javax.swing.JFrame {

    /**
     * Creates new form FaceBeansFrame
     */
    public FaceBeansFrame() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FaceBeansFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FaceBeansFrame().setVisible(true);
            }
        });
    }
